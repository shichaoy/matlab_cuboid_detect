...
% Arrange output.
result_struct.intAdjacencyMatrix = INT_B;
result_struct.intMatrixX = INT_X .* INT_B;  % intersection x coordinate
result_struct.intMatrixY = INT_Y .* INT_B;  % intersection y coordinate
result_struct.u_a=u_a;   % >1 extended
result_struct.u_b=u_b;   % >1 extended
